...
var _this = undefined,
    _jsxFileName = "D:\\Repo\\Crypto\\web\\src\\sections\\Stack\\index.js";
...
var Stack = function Stack() {
  ...
  }, " Technology we use"), __jsx(_reusecore_Text__WEBPACK_IMPORTED_MODULE_6__["default"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23,
  ...
  }, "The project is beeing developed in most recent technology stack. ", __jsx("br", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
  ...
  }), "It is also an Open Source project!")))), __jsx(_reusecore_Layout__WEBPACK_IMPORTED_MODULE_3__["Row"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
  ...
  }, _assets_data_stack__WEBPACK_IMPORTED_MODULE_8__["default"].stack.map(function (item, index) {
    return __jsx(_reusecore_Image__WEBPACK_IMPORTED_MODULE_7__["default"], {
      src: item.imageSrc,
      alt: item.name,
      __self: _this,
      __source: {
...
//# sourceMappingURL=index.js.4c688721aaa9ca8bf5bc.hot-update.js.map